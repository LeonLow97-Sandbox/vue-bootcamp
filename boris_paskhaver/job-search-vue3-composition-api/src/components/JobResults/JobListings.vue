  ...
  computed: {
    ...
    ...mapState(useJobsStore, {
      ...
      nextPage() {
        ...
        const lastPage = Math.ceil(this.FILTERED_JOBS.length / 10) // round up to the next whole number in case there are e.g., 15 jobs
      ...
      displayedJobs() {
        ...
        return this.FILTERED_JOBS.slice(firstJobIndex, lastJobIndex) // pagination of 10 pieces of data
      }
    })
  },
